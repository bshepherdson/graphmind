...
-- declared in the Graphmind.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
approot = "http://csclub.uwaterloo.ca/~bsshephe/graphmind"
#else
...
--
-- If you change the resource pattern for StaticR in Graphmind.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in Graphmind.hs
staticroot :: String
